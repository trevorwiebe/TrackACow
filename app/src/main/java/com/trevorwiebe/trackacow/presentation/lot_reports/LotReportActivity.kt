...
class LotReportActivity : AppCompatActivity() {
    ...
    // TODO: fix padding variance between drug report and feed report button
    // TODO: fix issue in cattle received rv where there is no space between 'Date' and the date
